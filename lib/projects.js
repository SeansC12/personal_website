...
\nThe React server, running on the client, sends a POST request to the Flask server, with the image of the pills from the camera feed attached as the payload. 
